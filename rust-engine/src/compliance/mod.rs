...
pub fn get_state_rules(state: &str) -> StateRule {
    match state.to_uppercase().as_str() {
        ...
        "GA" => StateRule {
            ...
            requires_disclosure: true,
            min_age: Some(18),
            banned_categories: vec!["gambling".into(), "tobacco".into(), "firearms".into()],
        },
        "OH" => StateRule {
            state: "OH".into(),
            nil_allowed: true,
        ...
        "MI" => StateRule {
            ...
            requires_disclosure: true,
            min_age: Some(18),
            banned_categories: vec!["gambling".into(), "cannabis".into()],
        },
        "PA" => StateRule {
            state: "PA".into(),
            nil_allowed: true,
            max_deal_amount_cents: Some(750_000_00), // $750K cap
            requires_disclosure: true,
            min_age: Some(18),
            banned_categories: vec!["gambling".into(), "tobacco".into()],
        },
        ...
        "LA" => StateRule {
            ...
            requires_disclosure: true,
            min_age: Some(18),
            banned_categories: vec!["gambling".into(), "alcohol".into(), "tobacco".into()],
        },
        "TN" => StateRule {
            state: "TN".into(),
            nil_allowed: true,
        ...
        "IL" => StateRule {
            state: "IL".into(),
            nil_allowed: true,
            max_deal_amount_cents: Some(600_000_00), // $600K cap
            requires_disclosure: true,
            min_age: Some(18),
            banned_categories: vec!["gambling".into(), "tobacco".into()],
        },
        "NJ" => StateRule {
            state: "NJ".into(),
            nil_allowed: true,
            max_deal_amount_cents: Some(500_000_00), // $500K cap (same as NY)
            requires_disclosure: true,
            min_age: Some(18),
            banned_categories: vec!["gambling".into(), "tobacco".into(), "cannabis".into()],
        },
