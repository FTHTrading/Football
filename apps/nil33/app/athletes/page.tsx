...
const ATHLETES = [
  ...
  },
  {
    ...
    rating: 5.0,
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Olivia_Dunne_2025_%28cropped%29.jpg/800px-Olivia_Dunne_2025_%28cropped%29.jpg",
    profileImage: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Olivia_Dunne_2025_%28cropped%29.jpg/800px-Olivia_Dunne_2025_%28cropped%29.jpg",
  ...
  },
  {
    ...
    collective: "\u2014",
    rating: 5.0,
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/JuJu_Watkins_2025.jpg/800px-JuJu_Watkins_2025.jpg",
    profileImage: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/JuJu_Watkins_2025.jpg/800px-JuJu_Watkins_2025.jpg",
  ...
  },
  {
    ...
    collective: "Bayou Traditions",
    rating: 4.5,
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/Flaujae_Johnson_2025.jpg/800px-Flaujae_Johnson_2025.jpg",
    profileImage: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/Flaujae_Johnson_2025.jpg/800px-Flaujae_Johnson_2025.jpg",
  ...
  },
  {
    ...
    collective: "\u2014",
    rating: 5.0,
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/AJ_Dybantsa_2024.jpg/800px-AJ_Dybantsa_2024.jpg",
    profileImage: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/AJ_Dybantsa_2024.jpg/800px-AJ_Dybantsa_2024.jpg",
  ...
  },
  {
    ...
    collective: "Gator Collective",
    rating: 5.0,
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/55/Jac_Caglianone_%2854550893410%29_%28cropped%29.jpg/800px-Jac_Caglianone_%2854550893410%29_%28cropped%29.jpg",
    profileImage: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/55/Jac_Caglianone_%2854550893410%29_%28cropped%29.jpg/800px-Jac_Caglianone_%2854550893410%29_%28cropped%29.jpg",
    socialFollowers: "520K",
    cardStats: [
      { label: "HR", value: "31" },
      { label: "BA", value: ".438" },
    ...
    detailMetrics: [
      { label: "Home Runs", value: "31" },
      { label: "Batting Average", value: ".438" },
      { label: "OPS", value: "1.396" },
      { label: "ERA", value: "2.14" },
      { label: "Strikeouts", value: "122" },
      { label: "Exit Velocity", value: "97.8 MPH" },
      { label: "Launch Angle", value: "15.2°" },
      { label: "Pitch Velocity", value: "97 MPH" },
      { label: "Spin Rate", value: "2,480 RPM" },
      { label: "K/9", value: "12.6" },
    ],
    nil: { composite: 89, low: 1400000, high: 2200000, social: 74, athletic: 97, market: 86, brand: 82 },
    deals: ["Marucci", "Rawlings", "Celsius", "FloSports"],
    bio: "The most dominant two-way player in college baseball history. 6\u20194\u201d first baseman and ace pitcher who set NCAA records with 31 home runs while posting a sub-2.15 ERA on the mound. Incredible .438 BA and 1.396 OPS from a two-way player. 6th overall pick in the 2024 MLB Draft by the Kansas City Royals. Florida\u2019s SEC market and unprecedented offensive production created record NIL valuations for collegiate baseball.",
    receiptId: "NIL33-2026-00111",
    signature: "ed25519:e9f3a7b1c5d8e2f6a4b9c3d7e1f5a8b2c6d4e9f3a7b1c5d8e2f6a4b9c3d7e1",
  },
  {
    id: "jordy-bahl",
    name: "Jordy Bahl",
    ...
    year: "Senior",
    agency: "Excel Sports Management",
    collective: "Husker Nation Collective",
    rating: 5.0,
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/Jordy_Bahl_%2853014154096%29_%28cropped%29.jpg/800px-Jordy_Bahl_%2853014154096%29_%28cropped%29.jpg",
    profileImage: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/Jordy_Bahl_%2853014154096%29_%28cropped%29.jpg/800px-Jordy_Bahl_%2853014154096%29_%28cropped%29.jpg",
    socialFollowers: "380K",
    cardStats: [
      { label: "ERA", value: "0.98" },
      { label: "K", value: "298" },
      { label: "W", value: "29" },
      { label: "K/7", value: "14.2" },
    ],
    detailMetrics: [
      { label: "ERA", value: "0.98" },
      { label: "Strikeouts", value: "298" },
      { label: "Wins", value: "29" },
      { label: "K/7 innings", value: "14.2" },
      { label: "WHIP", value: "0.64" },
      { label: "Opponents BA", value: ".148" },
      { label: "Pitch Velocity", value: "69 MPH" },
      { label: "Spin Rate", value: "2,310 RPM" },
      { label: "Complete Games", value: "18" },
      { label: "Shutouts", value: "12" },
    ],
    nil: { composite: 82, low: 750000, high: 1200000, social: 72, athletic: 96, market: 78, brand: 80 },
    deals: ["Mizuno", "Rawlings", "Gatorade", "Pepsi"],
    bio: "NFCA National Freshman of the Year at Oklahoma in 2022 and National Player of the Year in 2025 at Nebraska. The most dominant pitcher in collegiate softball \u2014 historically low 0.98 ERA with 298 strikeouts in a single season. Transferred to Nebraska and immediately elevated the Cornhuskers into national title contention. Premier softball NIL property in the Big Ten.",
    receiptId: "NIL33-2026-00112",
    signature: "ed25519:f2a8b4c9d3e7f1a5b2c6d8e4f9a3b7c1d5e2f8a4b6c9d3e7f1a5b2c6d8e4f9",
  },
];
...
const SPORT_COLORS: Record<string, string> = {
  ...
  Baseball: "bg-nil-gold/20 text-nil-gold border-nil-gold/30",
  Softball: "bg-rose-500/20 text-rose-400 border-rose-500/30",
};
